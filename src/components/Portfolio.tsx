...
const Portfolio = () => {
  return (
    <div className="bg-primary p-24 h-fit w-screen items-center justify-center  sx:max-sm:h-fit sx:max-sm:pt-20">
      <h3 className="text-text-color text-center mb-10 text-3xl sx:max-sm:text-2xl">
        Current Projects
      </h3>
      <div className="flex justify-center sx:max-sm:flex-col">
        <div className="card lg:card-side bg-base-100 shadow-xl mr-8 sx:max-sm:mb-8 ">
          <figure>
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title sx:max-sm:text-center">
              Mobile App React Native: Job Portal
            </h2>
            <p className="sx:max-sm:text-center">
